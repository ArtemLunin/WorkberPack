  ...
  if (path && postid != 0) {
    ...
    var switchLocality = function switchLocality(e) {
      ...
      if (target.matches('.locality')) {
        ...
        if (needInit) {
          _modules_storage__WEBPACK_IMPORTED_MODULE_23__["setLocalityStatus"](localityStatus);
          reloadCurrentPage();
        }
      }
    };
...
/*!*********************************!*\
  !*** ./src/js/modules/forms.js ***!
  \*********************************/
/*! exports provided: checkPassword, showSignError, hideSignError, submitSignForm */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "checkPassword", function() { return checkPassword; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "showSignError", function() { return showSignError; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "hideSignError", function() { return hideSignError; });
...
/* harmony import */ var _network__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./network */ "./src/js/modules/network.js");
/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./config */ "./src/js/modules/config.js");
...
var showSignError = function showSignError(errorContainer, errorMsg) {
  errorContainer.textContent = errorMsg;
  errorContainer.classList.remove('d-none');
};
var hideSignError = function hideSignError(errorContainer) {
  errorContainer.textContent = '';
  errorContainer.classList.add('d-none');
};
var submitSignForm = function submitSignForm(form, errorSignSelector, modalOverlayClass, modalOverlay) {
  ...
  if (btnSubmit.getAttribute('type') === 'submit') {
    ...
    Object(_network__WEBPACK_IMPORTED_MODULE_10__["sendRequest"])(_config__WEBPACK_IMPORTED_MODULE_11__["workberBackEnd"], formData).then(function (data) {
      if (data.error) {
...
var showModalVerification = function showModalVerification(prevModalOverlay, modalOverlayClass) {
  var modalOverlay = Object(_modal__WEBPACK_IMPORTED_MODULE_12__["renderModalVerification"])(modalOverlayClass);
...
/*!*********************************!*\
  !*** ./src/js/modules/modal.js ***!
  \*********************************/
/*! exports provided: commonModalOpenClass, modalMap, renderModalSign, renderModalVerification */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "renderModalVerification", function() { return renderModalVerification; });
/* harmony import */ var core_js_modules_es_symbol__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.symbol */ "./node_modules/core-js/modules/es.symbol.js");
/* harmony import */ var core_js_modules_es_symbol__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_symbol__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var core_js_modules_es_symbol_description__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/es.symbol.description */ "./node_modules/core-js/modules/es.symbol.description.js");
/* harmony import */ var core_js_modules_es_symbol_description__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_symbol_description__WEBPACK_IMPORTED_MODULE_1__);
...
var renderModalSign = function renderModalSign(modalOverlayClass, settingsSelector) {
  ...
  var loginForm = modalOverlay.querySelector('#loginForm');
  modalOverlay.querySelector('.menu__close').addEventListener('click', function () {
    modalOverlay.remove();
    enableScroll();
  });
  ...
  loginForm.addEventListener('submit', function (e) {
    e.preventDefault();
    Object(_forms__WEBPACK_IMPORTED_MODULE_12__["submitSignForm"])(e.target, '.errorSignMessage', modalOverlayClass, modalOverlay);
  });
  loginForm.addEventListener('reset', function () {
    Object(_forms__WEBPACK_IMPORTED_MODULE_12__["hideSignError"])(loginForm.querySelector('.errorSignMessage'));
  });
...
var renderModalVerification = function renderModalVerification(modalOverlayClass) {
  ...
  var verificationForm = modalOverlay.querySelector('#verificationForm');
  verificationForm.addEventListener('submit', function (e) {
    e.preventDefault(); // submitSignForm(e.target, '.errorSignMessage');
  });
  verificationForm.addEventListener('reset', function () {// hideSignError(loginForm.querySelector('.errorSignMessage'));
  });
  modalOverlay.querySelector('.menu__close').addEventListener('click', function () {
    modalOverlay.remove();
    enableScroll();
...
/*!***********************************!*\
  !*** ./src/js/modules/storage.js ***!
  \***********************************/
/*! exports provided: getLocation, setLocalityStatus, getLocalityStatus, iniBrowserLocation */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getLocation", function() { return getLocation; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "setLocalityStatus", function() { return setLocalityStatus; });
...
var setLocalityStatus = function setLocalityStatus(localityStatus) {
