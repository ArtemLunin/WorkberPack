...
/* harmony import */ var _modules_map__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./modules/map */ "./src/js/modules/map.js");
/* harmony import */ var _modules_config__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./modules/config */ "./src/js/modules/config.js");
/* harmony import */ var _modules_storage__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./modules/storage */ "./src/js/modules/storage.js");
/* harmony import */ var _modules_modal__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./modules/modal */ "./src/js/modules/modal.js");
/* harmony import */ var _modules_handlerPostData__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./modules/handlerPostData */ "./src/js/modules/handlerPostData.js");
/* harmony import */ var _modules_requests__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ./modules/requests */ "./src/js/modules/requests.js");
/* harmony import */ var _modules_network__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ./modules/network */ "./src/js/modules/network.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var paramsURI = new URLSearchParams(location.search.substring(1));
  postid = paramsURI.get('postid');
  var originURI = new URL(location);
  var originPath = "".concat(originURI.origin).concat(originURI.pathname);
  var newURI = new URL("".concat(originURI.origin).concat(originURI.pathname));
  var pathname = location.pathname;
  var path = pathname.match(/post-view\.html/);

  if (path && postid != 0) {
    var redirect = pathname.replace(/post-view\.html/, "index.html?page=post&postid=".concat(postid));
    location.href = redirect;
  } else {
    var isLogined = 0;
    var waitForLoad = 0;
    var mainPage = document.querySelector('.main-page');
    var postsOffer = document.querySelector('.posts-offer');
    var postsStart = document.querySelector('.posts-start');
    var postsNeed = document.querySelector('.posts-need');
    var postsAll = document.querySelector('.posts-all');
    var postsOne = document.querySelector('.post-one'); // const serviceOffer = document.querySelector('.offer');
    // const serviceNeed = document.querySelector('.need');
    // const startPostText = document.querySelector('.start-post-text');

    var workberHome = document.querySelector('.workber-logo');
    var workberLogo = document.querySelector('.workber-logo img');
    var distanceInfo = document.querySelector('.distance-info');
    var distances = document.querySelector('.distances');
    var distText = document.querySelector('.dist-text');
    var distTextHeader = document.querySelector('.dist-text-header');
    ...
    var tabsServices = document.querySelector('.tabs-service');
    var searchService = document.querySelector('.search-service');
    var searchProject = document.querySelector('.search-project');
    var searchAll = document.querySelector('.service-search-all');
    var iconSearchPage = document.querySelector('.icon-search-page');
    var notFound = document.querySelector('.not-found');
    var noMorePosts = document.querySelector('.no-more-posts');
    var searchSpinner = document.querySelector('.search-spinner');
    var searchBlock = document.querySelector('.search-block');
    var tabsLocality = document.querySelector('.tabs-locality');
    var localityHome = document.querySelector('.locality-home');
    var localityLocal = document.querySelector('.locality-local'); // const btnSetLocation = document.querySelector('.btn__setLocation');
    ...
    var currentPage = 'doStart';
    workberHome.dataset['currentPage'] = 'doStart';
    var pages = ['service', 'project', 'all', 'post'];
    var eventClick = new Event("click");
    var eventScroll = new Event("scroll");
    var currentlyLoad = 0; // в данный момент загружено 0 элементов

    var postsOfferShowned = 1; // сейчас показывается offer

    var scrollSearchActivated = 0;
    var scrollFeed = 0; // let scrollDisabled = 0;

    var onePostShowned = 0;
    var localityStatus = ''; // let globalPostID = null;

    postsOffer.textContent = '';
    postsNeed.textContent = '';
    postsStart.textContent = '';

    var renderOnePost = function renderOnePost(postData, postsContainer) {
      postsContainer.textContent = ''; // const aMain = backMenu.querySelector('a');
      // aMain.href = '.';

      if (postData && postData.post) {
        var post = Object(_modules_handlerPostData__WEBPACK_IMPORTED_MODULE_25__["createPost"])(postData.post, isLogined);
        postsContainer.append(post);
        var lat = parseFloat(postData.post.lat);
        var lng = parseFloat(postData.post.lng);
        var city = parseFloat(postData.post.city);
        Object(_modules_map__WEBPACK_IMPORTED_MODULE_21__["setPostCoordsMap"])(lat, lng, city);
      }
    ...
    var renderStartPosts = function renderStartPosts(_ref, postsContainer) {
      var posts = _ref.posts,
          last_postid = _ref.last_postid,
          last_dist = _ref.last_dist,
          code = _ref.code;
      var currentPageName = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '';
      var div = document.createElement('div');
      div.classList.add('posts-row');
      posts.forEach(function (postData) {
        var postFeed = Object(_modules_handlerPostData__WEBPACK_IMPORTED_MODULE_25__["createStartPostFeed"])(postData, currentPageName);
    ...
    var renderSearchPosts = function renderSearchPosts(_ref2, postsContainer) {
      var zones = _ref2.zones,
          last_postid = _ref2.last_postid,
          last_dist = _ref2.last_dist,
          code = _ref2.code;
      var currentPageName = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '';
      postsContainer.dataset.last_postid = last_postid;
      postsContainer.dataset.last_dist = last_dist;
      ...
      if (zones.length == 0 && postsContainer.textContent === '') {
        ...
        zones.forEach(function (item) {
          var zonesName = item.name;
          item.posts.forEach(function (postData) {
            ...
            var postFeed = Object(_modules_handlerPostData__WEBPACK_IMPORTED_MODULE_25__["createPostFeed"])(postData, isLogined, currentPageName);
    ...
    var renderSearchAll = function renderSearchAll(data) {
      console.log(data);
    };

    var getPostByID = function getPostByID(postid, postsContainer, callback) {
      var params;
      return regeneratorRuntime.async(function getPostByID$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              getDataSearch(Object(_modules_requests__WEBPACK_IMPORTED_MODULE_26__["createRequestParams"])(currentPage, showControl[currentPage].callParams, params), postsContainer, callback);
    ...
    var changeSearch = function changeSearch(e) {
      ...
      if (target.matches('.service')) {
        if (!target.matches('.service-selected') || currentPage == 'doStart') {
          ...
          var searchPage = target.dataset.service;
    ...
    var goSearch = function goSearch(searchPage, keywords, renderPosts) {
      currentPage = searchPage;
      var params = selectLocation();
      ...
      getDataSearch(Object(_modules_requests__WEBPACK_IMPORTED_MODULE_26__["createRequestParams"])(currentPage, showControl[currentPage].callParams, params), postsOffer, renderPosts);
      enableElemsStart(searchPage);
    };

    var showFeedSearch = function showFeedSearch() {
      ...
      if (postsStart.textContent == '') {
        var params = selectLocation();
        getDataSearch(Object(_modules_requests__WEBPACK_IMPORTED_MODULE_26__["createRequestParams"])(currentPage, showControl[currentPage].callParams, params), postsStart, renderStartPosts);
      }
    ...
    var getDataSearch = function getDataSearch(searchQuery, postsContainer, callback) {
      var currentPageName, formdata, callParam;
      return regeneratorRuntime.async(function getDataSearch$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 2:
              ...
              currentPageName = searchQuery.params.currentPageName;
              delete searchQuery.params.currentPageName;
              waitForLoad++;
              formdata = new FormData();
              formdata.append("call", searchQuery.call);

              for (callParam in searchQuery.params) {
                formdata.append(callParam, searchQuery.params[callParam]);
              }

              Object(_modules_network__WEBPACK_IMPORTED_MODULE_27__["sendRequest"])(_modules_config__WEBPACK_IMPORTED_MODULE_22__["workberBackEnd"], formdata).then(function (data) {
    ...
    var addEvents = function addEvents() {
      var postShare = document.querySelectorAll('.new-post-share');
      postShare.forEach(function (item) {
      ...
      var newPost = document.querySelectorAll('.new-post');
      newPost.forEach(function (item) {
        item.classList.remove('new-post');
        var postMoreInfo = item.querySelector('.post-text-more');

        if (postMoreInfo) {
          var postText = item.querySelector('.post-text');
    ...
    var toggleService = function toggleService(targetService) {
    ...
    var enableElemsStart = function enableElemsStart(callName) {
      if (currentlyLoad >= waitForLoad) {
        searchSpinner.classList.add('d-none');
        hidePageElems(callName);
        showPageElems(callName);

        if (showControl[currentPage].container.dataset.code === _modules_config__WEBPACK_IMPORTED_MODULE_22__["endSearchCode"]) {
          noMorePosts.classList.remove('d-none');
        } else {
          noMorePosts.classList.add('d-none');
        }

        var divNotFound = showControl[currentPage].container.querySelector('.not-found');
    ...
    var hidePageElems = function hidePageElems(callName) {
      // if(showControl[callName]?.hide) {
      showControl[callName].hide.forEach(function (item) {
        controlElems(item, 'hide');
      }); // }
    };

    var showPageElems = function showPageElems(callName) {
      // if(showControl[callName]?.show) {
      showControl[callName].show.forEach(function (item) {
        controlElems(item, 'show');
      }); // }
    };

    var controlElems = function controlElems(classElems, todo) {
      var elems = document.querySelectorAll(".".concat(classElems));
    ...
    var showOnePost = function showOnePost(postid) {
      backMenu.dataset['prevPage'] = currentPage;
      var onePostFeed = document.querySelector('#' + currentPage + '_postid_' + postid);
      ...
      if (!!onePostFeed) {
        ...
        try {
          ...
          var user_picture = onePostFeed.querySelector('.user-data').dataset.avatar;
          var user_name = onePostFeed.querySelector('.post-username').textContent;
          var collage = [];
          collage.name = onePostFeed.querySelector('.post-link img').attributes.src.value;
          var post_name = onePostFeed.querySelector('.post-title').textContent;
          var text_adv = onePostFeed.querySelector('.post-text').firstChild.textContent;
          var likes = onePostFeed.querySelector('.post-like').innerText;
          var hashtags = JSON.parse(onePostFeed.querySelector('.post-hashtags').dataset.hashtags);
          var role_ad = onePostFeed.querySelector('.post-hashtags').dataset.role_ad;
          var city = onePostFeed.querySelector('.location-city').textContent;
          var contactsList = {
          ...
          var post = Object(_modules_handlerPostData__WEBPACK_IMPORTED_MODULE_25__["createPost"])({
          ...
          var postContent = onePostFeed.querySelector('.post-content');
          var lat = parseFloat(postContent.dataset.lat);
          var lng = parseFloat(postContent.dataset.lng);
    ...
    var showMoreInfo = function showMoreInfo(e) {
      var target = e.target;
    ...
    var showHome = function showHome(e) {
      e.preventDefault();
      showControl[currentPage].scrollYPos = window.pageYOffset;
      clearSearchParam();
      currentPage = 'doStart';
    ...
    var showFeed = function showFeed(e) {
      e.preventDefault();
    ...
    var searchByTag = function searchByTag(e) {
      e.preventDefault();
      var target = e.target;
      onePostShowned = 0;
      ...
      if (target.classList.contains('a-hashtag')) {
        ...
        var hashTag = target.dataset['hashtag'];
    ...
    var postsScroll = function postsScroll(e) {
      var setZoneName = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
      var postsContainer = showControl[currentPage].container;
      var allVisible = Array.from(postsContainer.querySelectorAll('.post-feed')).filter(visible);

      if (!!allVisible[0] && !!allVisible[0].querySelector('.post-content')) {
        var zoneName = allVisible[0].querySelector('.post-content').dataset['zones'];
    ...
    var visible = function visible(elem) {
      ...
      if (rect.top > -1000 || rect.bottom < 1000) {
        var cond = rect.top + 400 >= 0 && rect.bottom - 400 <= (window.innerHeight || document.documentElement.clientHeight);
        return cond;
      }
    ...
    var switchLocality = function switchLocality(e) {
      var target = e.target;
      var needInit = false;
      ...
      if (target.matches('.locality')) {
        ...
        if (needInit) {
          ...
          _modules_storage__WEBPACK_IMPORTED_MODULE_23__["setGlobalItem"]({
    ...
    var selectLocation = function selectLocation() {
      var paramsLocation = {};
      localityStatus = _modules_storage__WEBPACK_IMPORTED_MODULE_23__["getLocalityStatus"]();
      ...
      if (localityStatus === 'locality-home') {
        var _storage$getLocation = _modules_storage__WEBPACK_IMPORTED_MODULE_23__["getLocation"](),
            _storage$getLocation2 = _slicedToArray(_storage$getLocation, 2),
            lat = _storage$getLocation2[0],
            lng = _storage$getLocation2[1];
    ...
    var notFoundPosts = function notFoundPosts() {
      var tempDiv = notFound.cloneNode(true);
    ...
    var reloadCurrentPage = function reloadCurrentPage() {
      ...
      if (currentPage === 'service' || currentPage === 'project') {
        ...
        var _hashTag = searchInput.value;
        showControl[currentPage].callParams.keywords = _hashTag;
        goSearch(currentPage, _hashTag, renderSearchAll);
      } else {
        postsStart.textContent = '';
        showFeedSearch();
      }
    ...
    var clickSearchButton = function clickSearchButton() {
      searchButton.dispatchEvent(eventClick);
    };

    var clickHomeButton = function clickHomeButton() {
      workberHome.dispatchEvent(eventClick);
    };

    var clearSearchParam = function clearSearchParam() {
    ...
    var checkScrollBottom = function checkScrollBottom() {
      ...
      /* && !scrollDisabled */
      && !document.querySelector(".".concat(_modules_modal__WEBPACK_IMPORTED_MODULE_24__["commonModalOpenClass"]))) {
        var windowRelativeBottom = document.documentElement.getBoundingClientRect().bottom;
    ...
    var doUploadPosts = function doUploadPosts() {
      ...
      var last_postid = postsContainer.dataset.last_postid;
      var last_dist = postsContainer.dataset.last_dist;
      var code = postsContainer.dataset.code;

      if (!!code && code == _modules_config__WEBPACK_IMPORTED_MODULE_22__["endSearchCode"] || currentlyLoad < waitForLoad) {
        scrollSearchActivated = 0;

        if (code == _modules_config__WEBPACK_IMPORTED_MODULE_22__["endSearchCode"]) {
          noMorePosts.classList.remove('d-none');
        }
      ...
      getDataSearch(Object(_modules_requests__WEBPACK_IMPORTED_MODULE_26__["createRequestParams"])(currentPage, showControl[currentPage].callParams, params), postsContainer, callBackRender);
      enableElemsStart(currentPage);
    };

    var URImod = function URImod(newURIParams) {
      var newSearchParams = new URLSearchParams();

      for (var key in newURIParams) {
        if (!!newURIParams[key]) {
          newSearchParams.set(key, newURIParams[key]);
        }
      }

      history.pushState(null, null, "".concat(originPath, "?").concat(newSearchParams.toString()));
    };
    ...
    if (workberLogo) {
      workberLogo.src = _modules_config__WEBPACK_IMPORTED_MODULE_22__["workberImages"] + '/site' + '/Workber-logo.svg';
    }
    ...
    if (!!mainPage) {
      _modules_storage__WEBPACK_IMPORTED_MODULE_23__["iniBrowserLocation"]();
      searchInput.value = '';
      var paramPage = paramsURI.get('page');
      ...
      if (!paramPage || pages.indexOf(paramPage) == -1) {
        ...
        if (paramPage == 'post' && (postid = paramsURI.get('postid'))) {
          ...
          var hashTag = paramsURI.get('hashtag');
  ...
  Object(_modules_modal__WEBPACK_IMPORTED_MODULE_24__["renderModalSign"])('modal-overlay', '.icon-settings');
  Object(_modules_map__WEBPACK_IMPORTED_MODULE_21__["mapLoader"])();
});
...
/* harmony import */ var _network__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./network */ "./src/js/modules/network.js");
/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./config */ "./src/js/modules/config.js");
/* harmony import */ var _storage__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./storage */ "./src/js/modules/storage.js");
/* harmony import */ var _appState__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./appState */ "./src/js/modules/appState.js");
/* harmony import */ var lodash_clonedeep__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! lodash.clonedeep */ "./node_modules/lodash.clonedeep/index.js");
...
var checkPassword = function checkPassword(passwords) {
  var errorMessage = '';
...
var showSignInfo = function showSignInfo(infoContainer, errorMsg) {
  infoContainer.textContent = '';
  errorMsg.forEach(function (item) {
    return infoContainer.innerHTML += "".concat(Object.values(item).join('<br>'));
  });
  infoContainer.classList.remove('d-none');
};
var hideSignInfo = function hideSignInfo(infoContainer) {
  infoContainer.textContent = '';
  infoContainer.classList.add('d-none');
};
var submitSignForm = function submitSignForm(form, errorSignSelector, modalSign, modalVerification) {
  var btnSubmit = document.activeElement;
  ...
  if (btnSubmit.getAttribute('type') === 'submit') {
    var typeSubmit = btnSubmit.getAttribute('id');
...
var submitResendForm = function submitResendForm(form, errorSignSelector, infoSignSelector) {
  var formData = new FormData(form);
...
var getDefaultContactsData = function getDefaultContactsData(contactsList) {
  var contactsData = {
    contact_phone: '',
    contact_email: '',
    contact_address: ''
  ...
  if (contactsList && typeof contactsList !== 'undefined') {
    var tempContact = contactsList[0];
...
var getUserAvatar = function getUserAvatar(userPicture, userName) {
  var user_img = null;

  if (userPicture && userPicture != 'null') {
    user_img = "<img src=\"".concat(userPicture, "\" alt=\"Post avatar\" class=\"post-avatar\"></img>");
  } else {
    user_img = "<span class=\"post-noavatar\">".concat(userName.substring(0, 1).toUpperCase(), "</span>");
  }

  return user_img;
};

var createPost = function createPost(_ref, isLogined) {
  var user_picture = _ref.user_picture,
      user_name = _ref.user_name,
      collage = _ref.collage,
      post_name = _ref.post_name,
      text_adv = _ref.text_adv,
      likes = _ref.likes,
      hashtags = _ref.hashtags,
      city = _ref.city,
      role_ad = _ref.role_ad,
      contactsList = _ref.contactsList;
  var post_img = '';
  var like_selected = '';
  var save_selected = '';
  var icon_selected = '';
  var hide_post_img = 'd-none';
  var hide_more = 'd-none';
  var hashtags_str = '';
  var user_img = getUserAvatar(user_picture, user_name);
  ...
  if (hashtags && hashtags.length > 0) {
    hashtags_str = hashtags.map(function (hashtag) {
      return "<a class=\"a-hashtag\" data-page=\"".concat(role_ad, "\" data-hashtag=\"").concat(hashtag.substring(1), "\" href=\"#\" title=\"Search by hashtag\">").concat(hashtag, "</a>");
    }).join(' ');
  }

  var _getDefaultContactsDa = getDefaultContactsData(contactsList),
      contact_phone = _getDefaultContactsDa.contact_phone,
      contact_email = _getDefaultContactsDa.contact_email,
      contact_address = _getDefaultContactsDa.contact_address;

  var div = document.createElement('div');
  div.classList.add('post');
  div.innerHTML = "\n\t\t\t<div class=\"post-body-view\">\n\t\t\t\t<div class=\"post-image ".concat(hide_post_img, "\">\n\t\t\t\t\t<img src=\"").concat(post_img, "\" alt=\"Post image\">\n\t\t\t\t</div>\n\t\t\t\t<div class=\"post-content\">\n\t\t\t\t\t<div class=\"post-activities\">\n\t\t\t\t\t\t<div class=\"post-action-group\">\n\t\t\t\t\t\t\t<button disabled class=\"post-action post-like ").concat(like_selected, "\">\n\t\t\t\t\t\t\t\t<svg width=\"24\" height=\"24\" class=\"icon ").concat(icon_selected, "\">\n\t\t\t\t\t\t\t\t\t<use xlink:href=\"assets/workber_img/icons.svg#btn-like\"></use>\n\t\t\t\t\t\t\t\t</svg>\n\t\t\t\t\t\t\t\t").concat(likes, "\n\t\t\t\t\t\t\t</button>\n\t\t\t\t\t\t\t<button disabled class=\"post-action post-save ").concat(save_selected, "\">\n\t\t\t\t\t\t\t\t<svg width=\"24\" height=\"24\" class=\"icon ").concat(icon_selected, "\">\n\t\t\t\t\t\t\t\t\t<use xlink:href=\"assets/workber_img/icons.svg#btn-save\"></use>\n\t\t\t\t\t\t\t\t</svg>\n\t\t\t\t\t\t\t\tSAVE\n\t\t\t\t\t\t\t</button>\n\t\t\t\t\t\t\t<button disabled class=\"post-action post-share\">\n\t\t\t\t\t\t\t\t<svg width=\"24\" height=\"24\" class=\"icon\">\n\t\t\t\t\t\t\t\t\t<use xlink:href=\"assets/workber_img/icons.svg#btn-share\"></use>\n\t\t\t\t\t\t\t\t</svg>\n\t\t\t\t\t\t\t\tSHARE\n\t\t\t\t\t\t\t</button>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<div class=\"post-more\">\n\t\t\t\t\t\t\t<span class=\"post-view ").concat(hide_more, "\">\n\t\t\t\t\t\t\t\t<a href=\"#\" class=\"icon-more\">\n\t\t\t\t\t\t\t\t\t<svg width=\"24\" height=\"24\" class=\"icon\">\n\t\t\t\t\t\t\t\t\t\t<use xlink:href=\"assets/workber_img/icons.svg#btn-more\"></use>\n\t\t\t\t\t\t\t\t\t</svg>\n\t\t\t\t\t\t\t\t</a>\n\t\t\t\t\t\t\t</span>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t\t<div class=\"post-title\">\n\t\t\t\t\t\t").concat(post_name, "\n\t\t\t\t\t</div>\n\t\t\t\t\t<div class=\"post-text\">\n\t\t\t\t\t\t").concat(text_adv, "\n\t\t\t\t\t</div>\n\t\t\t\t\t<div class=\"post-text post-hashtags hashtags-links\">\n\t\t\t\t\t\t").concat(hashtags_str, "\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t\t\n\t\t\t</div>\n\t\t\t<div class=\"post-view-footer\">\n\t\t\t\t<div class=\"user-data\">\n\t\t\t\t\t").concat(user_img, "\n\t\t\t\t\t<div>\n\t\t\t\t\t\t<p class=\"post-username\">").concat(user_name, "</p>\n\t\t\t\t\t\t<p class=\"location-city\">").concat(city, "</p>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t\t<!--<a href=\"#\" class=\"post-contacts\">Show Sontacts</a>-->\n\t\t\t\t<div class=\"post-contact-info\">\n\t\t\t\t\t<p class=\"post-contact-phone\"><a href=\"tel:").concat(contact_phone.replace(/\+|-|\s|\(|\)/g, ''), "\">").concat(contact_phone, "</a></p>\n\t\t\t\t\t<p class=\"post-contact-email\"><a href=\"mailto:").concat(contact_email, "\">").concat(contact_email, "</a></p>\n\t\t\t\t\t<p class=\"post-contact-address\">").concat(contact_address, "</p>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t\t<div class=\"post-map-show location\" id=\"post-map-show\" >\n\t\t\t</div>\n\t\t\t");
  return div;
};
var createStartPostFeed = function createStartPostFeed(_ref2) {
  var id = _ref2.id,
      user_picture = _ref2.user_picture,
      user_name = _ref2.user_name,
      collage = _ref2.collage,
      post_name = _ref2.post_name,
      text_adv = _ref2.text_adv,
      likes = _ref2.likes,
      role_ad = _ref2.role_ad,
      hashtags = _ref2.hashtags,
      shortlink = _ref2.shortlink,
      dist = _ref2.dist,
      lat = _ref2.lat,
      lng = _ref2.lng,
      city = _ref2.city,
      contactsList = _ref2.contactsList;
  var currentPageName = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
  ...
  var post_img = '';
  var hide_post_img = 'd-none';
  var hide_post_text = 'd-none';
  var serviceClass = 'service-offer';
  var serviceInfo = 'I OFFER';
  var user_img = getUserAvatar(user_picture, user_name);
  ...
  var _getDefaultContactsDa2 = getDefaultContactsData(contactsList),
      contact_phone = _getDefaultContactsDa2.contact_phone,
      contact_email = _getDefaultContactsDa2.contact_email,
      contact_address = _getDefaultContactsDa2.contact_address;

  var div = document.createElement('div');
  div.classList.add('post-col', 'new-post');
  div.setAttribute('id', "".concat(currentPageName, "_postid_").concat(id));
  div.dataset.showPageName = 'showOnePost';
  div.dataset.postid = id;
  hide_post_img = 'd-none'; // hide_post_text = '';

  if (post_img !== '') {
    div.style.background = "no-repeat center/cover url(\"".concat(post_img, "\")");
  }

  div.innerHTML = "\n\t\t<div class=\"user-data d-none\" data-avatar=\"".concat(user_picture, "\">\n\t\t\t").concat(user_img, "\n\t\t\t<span class=\"post-username\">").concat(user_name, "</span>\n\t\t\t<p class=\"location-city\">").concat(city, "</p>\n\t\t</div>\n\t\t<div class=\"d-none post-like\">\n\t\t\t").concat(likes, "\n\t\t</div>\n\t\t<div class=\"post-hashtags d-none\" data-hashtags=").concat(JSON.stringify(hashtags), " data-role_ad=\"").concat(role_ad, "\">\n\t\t</div>\n\t\t<div class=\"").concat(hide_post_img, "\">\n\t\t\t<a class=\"post-link \" href=\"").concat(shortlink, "\" data-postid=\"").concat(id, "\">\n\t\t\t\t<img src=\"").concat(post_img, "\" alt=\"Post image\">\n\t\t\t</a>\n\t\t</div>\n\t\t<div class=\"post-content\" data-dist=\"").concat(dist, "\" data-lat=\"").concat(lat, "\" data-lng=\"").concat(lng, "\">\n\t\t\t<div class=\"start-post-text ").concat(hide_post_text, "\">\n\t\t\t\t<div class=\"post-title\">\n\t\t\t\t\t").concat(post_name, "\n\t\t\t\t</div>\n\t\t\t\t<div class=\"post-text post-text-preview preview-start\">\n\t\t\t\t\t").concat(text_adv, "\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t</div>\n\t\t<div class=\"post-contact-info d-none\">\n\t\t\t<p class=\"post-contact-phone\">").concat(contact_phone, "</p>\n\t\t\t<p class=\"post-contact-email\">").concat(contact_email, "</p>\n\t\t\t<p class=\"post-contact-address\">").concat(contact_address, "</p>\n\t\t</div>\n\t\t<span class=\"service-info ").concat(serviceClass, "\">").concat(serviceInfo, "</span>\n\t");
  return div;
};
var createPostFeed = function createPostFeed(_ref3, isLogined) {
  var id = _ref3.id,
      user_picture = _ref3.user_picture,
      user_name = _ref3.user_name,
      collage = _ref3.collage,
      post_name = _ref3.post_name,
      text_adv = _ref3.text_adv,
      likes = _ref3.likes,
      hashtags = _ref3.hashtags,
      shortlink = _ref3.shortlink,
      lat = _ref3.lat,
      lng = _ref3.lng,
      city = _ref3.city,
      role_ad = _ref3.role_ad,
      dist = _ref3.dist,
      contactsList = _ref3.contactsList,
      zonesName = _ref3.zonesName;
  var currentPageName = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '';
  ...
  var _getDefaultContactsDa3 = getDefaultContactsData(contactsList),
      contact_phone = _getDefaultContactsDa3.contact_phone,
      contact_email = _getDefaultContactsDa3.contact_email,
      contact_address = _getDefaultContactsDa3.contact_address;
  ...
  div.setAttribute('id', "".concat(currentPageName, "_postid_").concat(id));
  div.dataset.showPageName = 'showOnePost';
  div.innerHTML = "\n\t\t\t<div class=\"post-header\">\n\t\t\t\t<div class=\"user-data\" data-avatar=\"".concat(user_picture, "\">\n\t\t\t\t\t").concat(user_img, "\n\t\t\t\t\t<div>\n\t\t\t\t\t\t<p class=\"post-username\">").concat(user_name, "</p>\n\t\t\t\t\t\t<p class=\"location-city\">").concat(city, "</p>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t\t<!--<a href=\"#\" class=\"post-contacts\">Show Sontacts</a>-->\n\t\t\t\t<div class=\"post-contact-info\">\n\t\t\t\t\t<p class=\"post-contact-phone\">").concat(contact_phone, "</p>\n\t\t\t\t\t<p class=\"post-contact-email\">").concat(contact_email, "</p>\n\t\t\t\t\t<p class=\"post-contact-address\">").concat(contact_address, "</p>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t\t<div class=\"post-body\">\n\t\t\t\t<div class=\"post-image ").concat(hide_post_img, "\">\n\t\t\t\t\t<a class=\"post-link\" href=\"").concat(shortlink, "\" data-postid=\"").concat(id, "\">\n\t\t\t\t\t\t<img src=\"").concat(post_img, "\" alt=\"Post image\">\n\t\t\t\t\t</a>\n\t\t\t\t</div>\n\t\t\t\t<div class=\"post-content\" data-dist=\"").concat(dist, "\" data-lat=\"").concat(lat, "\" data-lng=\"").concat(lng, "\" data-zones=\"").concat(zonesName, "\">\n\t\t\t\t\t<div class=\"post-activities\">\n\t\t\t\t\t\t<div class=\"post-action-group\">\n\t\t\t\t\t\t\t<button disabled class=\"post-action post-like ").concat(like_selected, "\">\n\t\t\t\t\t\t\t\t<svg width=\"24\" height=\"24\" class=\"icon ").concat(icon_selected, "\">\n\t\t\t\t\t\t\t\t\t<use xlink:href=\"assets/workber_img/icons.svg#btn-like\"></use>\n\t\t\t\t\t\t\t\t</svg>\n\t\t\t\t\t\t\t\t").concat(likes, "\n\t\t\t\t\t\t\t</button>\n\t\t\t\t\t\t\t<button disabled class=\"post-action post-save ").concat(save_selected, "\">\n\t\t\t\t\t\t\t\t<svg width=\"24\" height=\"24\" class=\"icon ").concat(icon_selected, "\">\n\t\t\t\t\t\t\t\t\t<use xlink:href=\"assets/workber_img/icons.svg#btn-save\"></use>\n\t\t\t\t\t\t\t\t</svg>\n\t\t\t\t\t\t\t\tSAVE\n\t\t\t\t\t\t\t</button>\n\t\t\t\t\t\t\t<button class=\"post-action post-share new-post-share\" data-link=\"").concat(shortlink, "\" title=\"Copy link to post\">\n\t\t\t\t\t\t\t\t<svg width=\"24\" height=\"24\" class=\"icon\">\n\t\t\t\t\t\t\t\t\t<use xlink:href=\"assets/workber_img/icons.svg#btn-share\"></use>\n\t\t\t\t\t\t\t\t</svg>\n\t\t\t\t\t\t\t\tSHARE\n\t\t\t\t\t\t\t</button>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<!--<div class=\"post-more\">\n\t\t\t\t\t\t\t<span class=\"post-view\">\n\t\t\t\t\t\t\t\t<a href=\"").concat(shortlink, "\" class=\"icon-more\" data-postid=\"").concat(id, "\">\n\t\t\t\t\t\t\t\t\t<svg width=\"24\" height=\"24\" class=\"icon\">\n\t\t\t\t\t\t\t\t\t\t<use xlink:href=\"assets/workber_img/icons.svg#btn-more\"></use>\n\t\t\t\t\t\t\t\t\t</svg>\n\t\t\t\t\t\t\t\t</a>\n\t\t\t\t\t\t\t</span>\n\t\t\t\t\t\t</div>-->\n\t\t\t\t\t</div>\n\t\t\t\t\t<div class=\"post-title\">\n\t\t\t\t\t\t").concat(post_name, "\n\t\t\t\t\t</div>\n\t\t\t\t\t<div class=\"post-text post-text-preview\">\n\t\t\t\t\t\t").concat(text_adv, "\n\t\t\t\t\t\t<span class=\"post-text-more d-none\">\u2026 more</span>\n\t\t\t\t\t</div>\n\t\t\t\t\t<div class=\"post-text post-hashtags d-none\" data-hashtags=").concat(JSON.stringify(hashtags), " data-role_ad=\"").concat(role_ad, "\">\n\t\t\t\t\t\t").concat(hashtags_str, "\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t</div>");
  return div;
};
...
var mapLoader = function mapLoader() {
  ...
  loader.load().then(function () {
    ...
    var mapInputs = document.createElement("div");
...
var setPositionOnMap = function setPositionOnMap(lat, lng) {
...
var setLocation = function setLocation(lat, lng) {
  var locationTrue = 0;
...
function setMarkerToMap(postLat, postLng, mapID) {
  var mapLocation = new google.maps.LatLng(postLat, postLng);
...
/*!*********************************!*\
  !*** ./src/js/modules/modal.js ***!
  \*********************************/
/*! exports provided: commonModalOpenClass, modalMap, renderModalSign */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _storage__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./storage */ "./src/js/modules/storage.js");
/* harmony import */ var _map__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./map */ "./src/js/modules/map.js");
/* harmony import */ var _forms__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./forms */ "./src/js/modules/forms.js");
/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./config */ "./src/js/modules/config.js");
/* harmony import */ var _appState__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./appState */ "./src/js/modules/appState.js");
...
var commonModalOpenClass = 'modal-open-class';
var modalMap = function modalMap(settingsSelector, btnCloseSelector, overlaySelector, overlayOpenClass) {
  var iconSettings = document.querySelector(settingsSelector);
  var locationBtnClose = document.querySelector(btnCloseSelector);
  var locationOverlay = document.querySelector(overlaySelector);

  var settingsModalOpen = function settingsModalOpen() {
    var _getLocation = Object(_storage__WEBPACK_IMPORTED_MODULE_10__["getLocation"])(),
        _getLocation2 = _slicedToArray(_getLocation, 2),
        lat = _getLocation2[0],
        lng = _getLocation2[1];

    locationBtnClose.dataset['lat'] = lat;
    locationBtnClose.dataset['lng'] = lng;
    Object(_map__WEBPACK_IMPORTED_MODULE_11__["setPositionOnMap"])(lat, lng);
    locationOverlay.classList.add(overlayOpenClass, commonModalOpenClass);
    disableScroll();
  };

  var settingsModalClose = function settingsModalClose() {
    locationOverlay.classList.remove(overlayOpenClass);
    enableScroll();

    var _getLocation3 = Object(_storage__WEBPACK_IMPORTED_MODULE_10__["getLocation"])(),
        _getLocation4 = _slicedToArray(_getLocation3, 2),
        lat = _getLocation4[0],
        lng = _getLocation4[1];
...
var renderModalSign = function renderModalSign(modalOverlayClass, settingsSelector) {
  var iconSettings = document.querySelector(settingsSelector);
  ...
  var switchSignMethod = function switchSignMethod(container, showSelector) {
    var menuItemShow = container.querySelector(showSelector);
    container.querySelectorAll('.menu__sign').forEach(function (item) {
      item.classList.remove('active');
    });
    menuItemShow.classList.add('active');
    container.querySelectorAll(".".concat(menuItemShow.dataset['items_show'])).forEach(function (item) {
      item.style.display = '';
      item.removeAttribute('disabled', '');
    });
    container.querySelectorAll(".".concat(menuItemShow.dataset['items_hide'])).forEach(function (item) {
  ...
  loginForm.elements['policy-agree'].addEventListener('click', function (e) {
    var target = e.target;
    toggleStatusElem(loginForm.querySelector("#".concat(target.dataset['control'])), target.checked);
  });
  loginForm.addEventListener('submit', function (e) {
    e.preventDefault();
    Object(_forms__WEBPACK_IMPORTED_MODULE_12__["submitSignForm"])(e.target, '.errorSignMessage', modalSign, modalVerification);
  });
...
/*!************************************!*\
  !*** ./src/js/modules/requests.js ***!
  \************************************/
/*! exports provided: createRequestParams */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createRequestParams", function() { return createRequestParams; });
var createRequestParams = function createRequestParams(callName, originParams, priorParams) {
  var call = 0;
  var params = {}; // originParam

  params['currentPageName'] = callName;

  if (originParams) {
    // apply priorParams first
    for (var item in priorParams) {
      if (!!priorParams[item]) {
        params[item] = priorParams[item];
      }
    }

    for (var _item in originParams) {
      if (_item == 'call') {
        call = originParams[_item];
        continue;
      }

      if (originParams[_item] !== null && !params[_item]) {
        params[_item] = originParams[_item];
      }
    }
  }
...
/*!***********************************!*\
  !*** ./src/js/modules/storage.js ***!
  \***********************************/
/*! exports provided: getLocation, setGlobalItem, getLocalityStatus, iniBrowserLocation */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var setGlobalItem = function setGlobalItem(item) {
  var packJSON = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
...
var getLocalityStatus = function getLocalityStatus() {
  var localityStatus = localStorage.getItem('localityStatus');
...
var iniBrowserLocation = function iniBrowserLocation() {
